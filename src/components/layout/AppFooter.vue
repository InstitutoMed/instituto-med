    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-about">
          ...
          <h5>Redes sociais</h5>
          <div class="social">
            <a href="#" aria-label="Instagram" @click.prevent></a>
            <a href="#" aria-label="Facebook" @click.prevent></a>
            <a href="#" aria-label="Twitter" @click.prevent></a>
            <a href="#" aria-label="GitHub" @click.prevent></a>
          </div>
        </div>
      ...
      <div class="footer-strip">
        ...
        <div class="item"> institutoMed@gmail.com</div>
        <div class="item"> Colégio Agrícola, Araquari, SC, Brasil</div>
      </div>
...
.footer-about .logo-img{height:30px;width:auto;}
...
.social a{width:34px;height:34px;border-radius:50%;background:rgba(255,255,255,.1);display:flex;align-items:center;justify-content:center;font-size:13px;}
