...
const form = reactive({
  ...
  telefone: '',
  cpf: '',
  consulta: 'Exame de Sangue',
  data: '',
  horario: '',
  hospital: 'Hospital Regional Hans Dieter Schmidt (HRHDS)',
  medico: 'Hanna Schroeder',
  motivo: '',
  senha: '',
  email: '',
  receberEmail: false
...
const tocado = reactive({ nome: false, telefone: false, cpf: false, data: false, senha: false, email: false })
...
const erros = computed(() => {
  const e = {}
  if (form.nome.length < 3) e.nome = 'Informe o nome completo.'
  if (!/^\(\d{2}\) \d{5}-\d{4}$/.test(form.telefone)) e.telefone = 'Telefone inválido.'
...
<main class="conteudo">
  <form @submit.prevent="confirmarAgendamento">
   ...
   <div class="cpf">
    ...
    <select id="inputconsulta" v-model="form.consulta" class="form-select">
    ...
    <div class="col-sm-10">
      <div class="opM">
        <input v-model="form.horario" class="form-check-input" type="radio" name="gridHorario" id="gridHorario1" value="Matutino">
      ...
      <div class="opV">
        <input v-model="form.horario" class="form-check-input" type="radio" name="gridHorario" id="gridHorario2" value="Vespertino">
      ...
      <div class="opN">
        <input v-model="form.horario" class="form-check-input" type="radio" name="gridHorario" id="gridHorario3" value="Noturno">
    ...
    <select id="inputhospital" v-model="form.hospital" class="form-select">
    ...
    <select id="inputmed" v-model="form.medico" class="form-select">
 ...
 <div class="email">
  ...
  <div class="senha">
    ...
    <div class="col-sm-10">
      <input v-model="form.senha" type="password" class="form-control" id="inputSenha" :class="{ invalido: erros.senha }" @blur="tocado.senha = true">
